...
<title>Tec Web | Cadastro de clientes</title>
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li class="treeview">
						<!-- link para paginas  --> <a href="#"> <i
							class="fa fa-user-plus"></i> <span>Cadastro Clientes</span> <span
							class="pull-right-container"> </span>
					</a>
						<ul class="treeview-menu">
							<li><a href="${pageContext.request.contextPath}/ControllerCliente" name="novoCliente""><i
								...
								<div class="box-body">
									<div class="form-group">
										<label for="nomeCliente">Nome</label> <input type="text"
											class="form-control" name="nomeCliente">
									</div>

									<div class="form-group">
										<label for="cpfCliente">CPF/CNPJ</label> <input type="text"
											class="form-control" name="cpfCliente">
									</div>
								</div>
						</div>
						<div class="box box-success">
							...
							<div class="box-body">
								<div class="input-group">
									...
									<input type="email" class="form-control" placeholder="Email" name="emailCliente">
								</div>
								<br>
								<div class="input-group">
									<div class="input-group-addon">
									...
									<input type="text" class="form-control" placeholder="Telefone" name="foneCliente">
								</div>
								<br>
								<div class="input-group">
									<div class="input-group-addon">
									...
									<input type="text" class="form-control" placeholder="Celular" name="celularCliente">
								</div>
